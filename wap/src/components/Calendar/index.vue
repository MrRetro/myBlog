  ...
  <div id="calendar">
    <div v-if="isFull">
      ...
      <div class="month">
        <ul>
          ...
          <yi-touch component-name="li" class="arrow" @click="pickPre(currentYear,currentMonth)">❮</yi-touch>
          <yi-touch component-name="li" class="year-month" @click="onSelTitle">
            <span class="choose-year">{{ currentYear }}年</span>
            <span class="choose-month">{{ currentMonth }}月</span>
          </yi-touch>
          <yi-touch component-name="li" class="arrow" @click="pickNext(currentYear,currentMonth)">❯</yi-touch>
        </ul>
      </div>
      <!-- 星期 -->
      <ul class="weekdays">
    ...
    <div v-else>
      ...
      <ul class="days">
        <!-- 核心 v-for循环 每一次循环用<li>标签创建一天 -->
        <li
          v-for="(dayobject, index) in curWeek"
          :key="'key'+index">
    ...
    <p class="btn-box">
      <yi-touch class="btn" @click="onCalendarClick">
        {{ isFull?'收起日历':'展开日历' }}
        <img v-if="isFull" class="img" :src="$images.follow.angle_top" alt="">
        <img v-else class="img" :src="$images.follow.angle_bottom" alt="">
      </yi-touch>
    </p>
  </div>
</template>
