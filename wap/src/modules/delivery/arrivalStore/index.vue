...
export default {
  ...
  computed: {
    ...
    info() {
      let list1 = [
        {title: '入库时间', key: 'freightIncome'},
        {title: '入库仓库', key: 'licensePlateIncome'},
        {title: '入库图片', key: 'images', type: 'images'}];
      let list2 = [
        {title: '入库时间', key: 'freightIncome'},
        {title: '手续详情', key: 'licensePlateIncome'},
        {title: '手续图片', key: 'images', type: 'images'}];
      return {
        type: 'section',
        data: [{
          title: '车辆详情',
